...
export function createBlogPostSuccess(blogPost) {
    console.log('blogPost Payload:', blogPost);
    return {
...
export const createNewBlogPost = (postData) => async(dispatch) => {
    ...
    try {
        ...
        console.log('singleBlogPostResponse:', response)
        console.log('singleBlogPostResponse data:', response.data)
        dispatch(createBlogPostSuccess(response.data));
      } catch (error) {
        console.log('singleBlogPostErrorResponse:', error)
...
export const handleUpdateBlogPost = (postData) => async(dispatch) => {
    dispatch(updateBlogPost());

    try {
        const response = await axios.patch(`/post/${postData.id}`, postData);
        console.log('singleBlogPostResponse on Update:', response.data)
