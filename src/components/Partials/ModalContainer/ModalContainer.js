...
const renderButton = (props) => {
    switch(props.actionName){
        ...
        case 'Update Post': return <Button color="primary" onClick={() => props.updatePost(props.guest)}>Update Post</Button>;
...
const renderForm = (props) => {
    switch(props.actionName){
        case 'Add Post': return <AddPostForm onChange={props.onChange} onCheckBox={props.onCheckBox} onMultiSelect={props.onMultiSelect} />;
        case 'Update Post': return <UpdatePostForm post={props.post} />;
